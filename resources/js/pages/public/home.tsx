        ...
        <PublicLayout>
            ...
            <section className="relative bg-slate-900 text-white">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col items-center text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        ...
                        <Button size="lg" variant="outline" className="text-slate-900 bg-white hover:bg-slate-100 text-lg px-8" asChild>
            ...
            <section className="py-16 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl font-bold text-slate-900 mb-4">{t('Who we are')}</h2>
            ...
            <section className="py-16 bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-slate-900">{t('Our Priority Actions')}</h2>
                        <p className="mt-4 text-lg text-slate-600">{t('Choose where your support goes with full transparency.')}</p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <Card className="hover:shadow-lg transition-shadow duration-300">
                            <CardHeader className="text-center">
                                ...
                                <CardTitle className="text-2xl">{t('Community Projects')}</CardTitle>
                        ...
                        <Card className="hover:shadow-lg transition-shadow duration-300">
                            <CardHeader className="text-center">
                                ...
                                <CardTitle className="text-2xl">{t('Vulnerable People')}</CardTitle>
                                <CardDescription className="text-base mt-2">
