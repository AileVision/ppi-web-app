...
interface EditTeamMemberProps {
    teamMember: {
        ...
        professional_title: Record<string, string>;
...
export default function EditTeamMember({ teamMember }: EditTeamMemberProps) {
    const breadcrumbs = [
        ...
        { title: 'Edit Member', href: `/admin/team/${teamMember.id}/edit` },
    ];
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('admin.team.update', teamMember.id));
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <Heading title="Edit Team Member" description="Update this member’s public profile." />

            <form onSubmit={submit} className="space-y-8 pb-10">
                <Card>
                    <CardHeader>
                        <CardTitle>Basic Information</CardTitle>
                        <CardDescription>Update the core details for this team member.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            {teamMember.photo_path && (
                                <img src={teamMember.photo_path} alt={teamMember.full_name} className="mt-2 h-24 w-24 rounded-lg object-cover" />
                            )}
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update the position and professional title in both languages.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Update the team member's role description in both languages.</CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
